...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        (444444, "Jos", "Joszoon", "Law", 12, 2, 2, 2, 2, 2, 2, 2, 2),
        (444445, "Lies", "Bakker", "Medical Diagnostics", 12, 2, 2, 2, 2, 2, 2, 2, 2),
        (444446, "Femke", "Prins", "Medical Diagnostics", 2, 12, 2, 2, 2, 2, 2, 2, 2),
        (444447, "Willem", "de Vries", "Medical Diagnostics", 2, 2, 12, 2, 2, 2, 2, 2, 2),
        (444448, "Selim", "Kirbiyik", "Teacher Dance", 2, 2, 2, 12, 2, 2, 2, 2, 2),
        (444449, "José", "Uniloop", "Theatre", 2, 2, 2, 2, 12, 2, 2, 2, 2),
        (444450, "David", "Sabelis", "Theatre", 2, 2, 2, 2, 2, 12, 2, 2, 2),
        (444451, "Jarno", "Robbe", "Law", 2, 2, 2, 2, 2, 2, 12, 2, 2),
        (444452, "Rob", "Robinson", "Law", 2, 2, 2, 2, 2, 2, 2, 12, 2),
        (444453, "Sophie", "Blom", "History", 2, 2, 2, 2, 2, 2, 2, 2, 12),
        (444454, "Asllan", "Ibrahimi", "History", 12, 2, 2, 2, 2, 2, 2, 2, 2),
        (444455, "Sem", "van der Vlugt", "History", 2, 12, 2, 2, 2, 2, 2, 2, 2),
        (444456, "Astrid", "Bolt", "Theatre", 2, 12, 2, 2, 2, 2, 2, 2, 2),
        (444457, "Linda", "Noordhuis", "Pabo", 2, 2, 12, 2, 2, 2, 2, 2, 2),
        (444458, "Pepijn", "Douwma", "Pabo", 2, 2, 2, 12, 2, 2, 2, 2, 2),
        (444459, "Wessel", "Berends", "Human movement science", 2, 2, 2, 2, 12, 2, 2, 2, 2),
        (444460, "Bart", "Bernard", "Geology", 2, 12, 2, 2, 2, 2, 2, 2, 2),
        (444461, "Erik", "Roos", "Geology", 2, 2, 2, 2, 2, 12, 2, 2, 2),
        (444462, "Sacha", "Veenstra", "Physics", 2, 2, 2, 2, 2, 2, 12, 2, 2),
        (444463, "Koen", "Hendrikse", "Physics", 2, 2, 2, 2, 2, 2, 2, 12, 2),
        (444464, "Koen", "Kooij", "Physics", 2, 2, 2, 2, 2, 2, 2, 2, 12),
        (444465, "Bas", "Holtman", "Physics", 2, 2, 2, 2, 2, 2, 12, 2, 2),
        (444466, "Joeke", "Schaafsma", "Physics", 12, 2, 2, 2, 2, 2, 2, 2, 2),]
        ...
        projects = [
        (1, "Climate protection", "The climate needs protection. Let's work on that together!", nienke),
        (2, "Motorcycle driving lessons", "Everyone should learn to drive a motorcycle", arjan),
        (3, "Software Startup", "Think of your own Software Startup and bring it to life.", martijn),
        ]
